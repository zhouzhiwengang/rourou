...
export default {
  ...
  methods: {
    ...
    hotSaleInit() {
        var result =[
            {'GoodImg':url('./../../images/good/pic-1.jpg'), 'Goodname':'小米6X', 'GoodPrice': '1299', 'GoodPriceaftersale':'1499'},
            {'GoodImg':'', 'Goodname':'飞科剃须刀', 'GoodPrice': '66', 'GoodPriceaftersale':'99'},
            {'GoodImg':'', 'Goodname':'华为honor', 'GoodPrice': '1199', 'GoodPriceaftersale':'1299'},
        ]
