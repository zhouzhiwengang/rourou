...
export default {
  ...
  methods: {
    ...
    saleGroupInit() {
        var result = [
            {'GoodImg': '@/images/good/pic-2.jpg', 'GoodPriceaftersale': '2699', 'Goodid': '1'},
            {'GoodImg': '@/images/good/pic-3.jpg', 'GoodPriceaftersale': '365', 'Goodid': '2'},
            {'GoodImg': '@/images/good/pic-7.jpg', 'GoodPriceaftersale': '1099', 'Goodid': '3'},
        ]
